...
// TODO： 后续写两个方法：1、根据ID获得string，考虑字典；2、根据ID获得描述，用于面板显示。允许存在外面，需要用的时候再说。之前的面板数据，看能不能做成map。魔剑技和合击注明，免疫伤害减少。切换触发条件时，用句号分割。
...
#define STATE_SLOT_ONE_DEBUFF_WITH_MAGIC_RAMDOM 21 // 邪灵附体 使用仙术造成伤害时：5%概率，精-9999；5%概率，获得虚弱、破甲、迟钝、厄运，持续5回合；90%概率，精-伤害量*50%
...
#define STATE_SLOT_ONE_HP_LOSS_DAMAGE_BASED_WHEN_ATTACK_PERCENTAGE_100 28// 死亡渴望 造成伤害时：精-伤害量*100%
#define STATE_SLOT_ONE_SP_MP_COST_TRANSFORM_TO_HP_PERCENTAGE_1000_500 29 // 分流 使用特技时：精-气消耗量*1000%，气消耗量-100%；使用仙术时：精-神消耗量*500%，神消耗量-100%
...
#define STATE_SLOT_ONE_HP_LOSS_WHEN_NORMAL_ATTACK_9999 34 // 静滞领域 使用普通攻击造成伤害时：精-9999
...
#define STATE_SLOT_ONE_SPEED_DECREASE_PERCENTAGE_ALL_DAMAGE_INCREASE_PERCENTAGE_84_90 49 // 蓄势 速-84%，受全部伤害-90%
...
#define STATE_SLOT_ONE_HP_LOSS_DAMAGE_BASED_ALL_PARTNER_WHEN_ATTACK_PERCENTAGE_10 76 // 灼烧 造成伤害时：己方所有角色精-伤害量*10%
